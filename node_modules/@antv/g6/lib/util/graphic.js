...
var GraphicUtil = {
   ...
   */
  getAutoZoomMatrix: function getAutoZoomMatrix(box1, box2, padding, limitRtio) {
    var matrix = [1, 0, 0, 0, 1, 0, 0, 0, 1];
    var width = box1.maxX - box1.minX;
    var height = box1.maxY - box1.minY;
    var centerX = (box2.maxX + box2.minX) / 2;
    var centerY = (box2.maxY + box2.minY) / 2;
    var cWidth = width - padding[1] - padding[3];
    var cHeight = height - padding[0] - padding[2];
    var bWidth = box2.maxX - box2.minX;
    var bHeight = box2.maxY - box2.minY;
   ...
   */
  toBack: function toBack(element) {
    element.toBack();
  },
   ...
   * @param  {object} element g shape or group
   */
  toFront: function toFront(element) {
    element.toFront();
  }
};
